export function Logo({ className = "", size = 40 }: { className?: string; size?: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Company name */}
      <text x="65" y="10" fontFamily="Oswald, Arial, sans-serif" fontSize="11" fontWeight="500" fill="#ffffff" textAnchor="middle">ЭКО</text>
      <text x="65" y="22" fontFamily="Oswald, Arial, sans-serif" fontSize="9" fontWeight="400" fill="#4ade80" textAnchor="middle" letterSpacing="1.5">КОМФОРТ</text>
      </g>
    </svg>
  )
}